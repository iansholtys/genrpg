...
CREATE TABLE IF NOT EXISTS genrpg.instance_user_permissions (
...
CREATE INDEX IF NOT EXISTS idx_instance_user_permissions_user
  ON genrpg.instance_user_permissions(user_guid);

DROP TRIGGER IF EXISTS instance_user_permissions_update_datetime ON genrpg.instance_user_permissions;
CREATE TRIGGER instance_user_permissions_update_datetime
  BEFORE UPDATE ON genrpg.instance_user_permissions
